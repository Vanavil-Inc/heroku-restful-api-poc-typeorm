 ...
 */
function contactDeleteByIdAction(request, response) {
    ...
    if (token != User.getToken()) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contact = yield contactRepository.delete(request.params.id);
...
exports.contactDeleteByIdAction = contactDeleteByIdAction;
//# sourceMappingURL=contactDeleteByIdAction.js.map